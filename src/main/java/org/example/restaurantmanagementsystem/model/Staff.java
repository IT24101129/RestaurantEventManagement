...
@Entity
@Table(name = "staff")
public class Staff<StaffSchedule> {
    @Id
    ...
    public List<StaffSchedule> getSchedules() { return schedules; }
    public void setSchedules(List<StaffSchedule> schedules) { this.schedules = schedules; }
